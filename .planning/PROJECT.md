...
- Rust backend (`services/`): DONE (6/6 plans: 01-01 auth, 01-02 custody config, 01-03 custody KMS, 01-04 stellar, 01-05 bridge, 01-06 TS client).
- `packages/stellar-sdk` (TS client): DONE (buildable + 4 vitest tests; branches on custody mode).
- Frontend↔backend wiring: NEXT (Phase 2; UI still calls `fakeTx`).
