    ...
    <section className="px-4 py-16 md:px-8 lg:px-12">
      <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-3">
        {[
          ...
          <article key={title} className={`cut-corner border-2 border-night p-6 text-center md:text-left ${index === 1 ? "bg-coral text-white" : index === 2 ? "bg-lime text-ink" : "bg-white text-ink"}`}>
