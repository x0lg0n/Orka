...
export default function LoginPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-night px-4 text-white">
      <div className="w-full max-w-md rounded-[28px] bg-white p-6 text-center text-night shadow-hard md:p-8">
