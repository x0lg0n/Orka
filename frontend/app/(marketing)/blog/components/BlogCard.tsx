  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="mt-2 text-[13px] font-bold leading-5 text-night/55 line-clamp-2">
          {post.excerpt}
        </p>
        <div className="mt-4 flex items-center gap-2.5">
          <span className="grid size-7 place-items-center rounded-full bg-violet/10 text-[10px] font-black text-violet">
            {post.author.initials}
          </span>
          <div>
            <p className="text-[12px] font-bold text-night">{post.author.name}</p>
            <p className="text-[10px] font-bold text-night/40">
              {post.publishedAt} · {post.readingTime}
            </p>
          </div>
        </div>
        <span className="mt-4 inline-flex items-center gap-1 text-[12px] font-black text-violet">
          Read Article{" "}
